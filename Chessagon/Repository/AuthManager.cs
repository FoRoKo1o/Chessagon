...
namespace Chessagon.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        private const string _loginProvider = "ChessagonAPI";
        ...
        private async Task<String> GemerateToken()
        {
            ...
            var token = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.Now.AddMinutes(Convert.ToDouble(_configuration["JWTSettings:DurrationInMinutes"])),
        ...
        public async Task<AuthResponseDto> VerifyRefreshToken(AuthResponseDto request)
        {
            ...
            var username = tokenContent.Claims.ToList().FirstOrDefault(tokenContent => tokenContent.Type == JwtRegisteredClaimNames.Email)?.Value;
